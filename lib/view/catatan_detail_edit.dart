...
class CatatanDetailEdit extends StatefulWidget {
  const CatatanDetailEdit({super.key});

  @override
  State<CatatanDetailEdit> createState() => _CatatanDetailEditState();
}

class _CatatanDetailEditState extends State<CatatanDetailEdit> {
  @override
